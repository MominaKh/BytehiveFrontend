...
const TextSelectionPopup = ({ position, selectedText, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="popup-content absolute bg-navbar-bg border border-navbar-border rounded-xl shadow-2xl w-96 max-w-sm"
        style={{
          left: Math.max(20, Math.min(position.x - 192, window.innerWidth - 404)),
